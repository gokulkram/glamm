...
export const DEFAULT_FAQS: Faq[] = [
  ...
  { id: -13, question: "What if my package is lost or damaged?", answer: "If your package is lost in transit or arrives damaged, please contact us immediately at support@glammhairextensions.com with your order number and photos (if damaged). We'll work with the carrier to resolve the issue and ensure you receive your extensions.", category: 'shipping', is_active: true, sort_order: 13 },
  { id: -14, question: "Can I change my shipping address after ordering?", answer: "If your order hasn't shipped yet, we can update your address. Please contact us as soon as possible at support@glammhairextensions.com with your order number and new address. Once shipped, we cannot modify the delivery address.", category: 'shipping', is_active: true, sort_order: 14 },
  ...
  { id: -22, question: "How do I initiate a return?", answer: "Contact our customer service team at support@glammhairextensions.com with your order number and reason for return. We'll provide a return authorization number and instructions. Once we receive and inspect the return, we'll process your refund within 5-7 business days.", category: 'returns', is_active: true, sort_order: 22 },
